...
public class CoinChange {
  ...
  public void solve() {
    // If denomenation value is 0, There is no solution, Filling 0 in first row.
    // Array already filled with 0;
    // If total value is 0, then only 1 possible solution is there, which is not to include that denomenation.
    // Filling 1 in first col.
    ...
    //     System.out.print((solution[i][j] > 9 ? solution[i][j] : (" " + solution[i][j]))+ " ");
    //     System.out.println();
    //   }
  }
