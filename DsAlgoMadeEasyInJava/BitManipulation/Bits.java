...
public class Bits {
  ...
  private void bitwiseAnd(int first, int second) {
    printInBinary(first);
  ...
  private void bitwiseXor(int first, int second) {
    printInBinary(first);
    printInBinary(second);
  ...
  private void bitwiseCompliment(int number) {
    printInBinary(number);
  ...
  private void bitwiseTwosCompliment(int number) {
    printInBinary(number);
  ...
  private void bitwiseOr(int first, int second) {
    printInBinary(first);
    printInBinary(second);
